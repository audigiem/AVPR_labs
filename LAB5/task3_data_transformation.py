...
def experiment_data_augmentation():
    ...
    for name, augmentation in augmentations.items():
        ...
        train_data = datasets.MNIST(
            root="./data", train=True, download=True, transform=augmentation
        )
        test_data = datasets.MNIST(
            root="./data", train=False, download=True, transform=test_transform
        )
...
def experiment_normalization_methods():
    ...
    for name, normalization in normalizations.items():
        ...
        train_data = datasets.MNIST(
            root="./data", train=True, download=True, transform=normalization
        )
        test_data = datasets.MNIST(
            root="./data", train=False, download=True, transform=normalization
        )
