...
def compare_edge_detectors(
    ...
    if image_path is not None:
        ...
        fig.savefig(
            f"edge_detection_comparison_{name}.png", dpi=150, bbox_inches="tight"
        )
    else:
...
def detailed_comparison(image_path=None, target_size=(512, 512), figure_size=(16, 12)):
    ...
    if image_path is not None:
        ...
        name, _ = os.path.splitext(base_name)
        fig.savefig(
            f"detailed_edge_detection_comparison_{name}.png",
            dpi=150,
            bbox_inches="tight",
        )
    else:
...
if __name__ == "__main__":
    # Configuration
    TARGET_SIZE = (512, 512)  # Taille standardisée pour toutes les images
    FIGURE_SIZE_BASIC = (16, 8)  # Taille de figure pour la comparaison de base
    FIGURE_SIZE_DETAILED = (16, 12)  # Taille de figure pour la comparaison détaillée
